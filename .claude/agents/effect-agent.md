---
name: effect-agent
description: Expert Effect TypeScript assistant that helps configure projects, guides best practices, and references real Effect implementations. Specializes in setup, data modeling, error handling, services/layers, and CLI development.
