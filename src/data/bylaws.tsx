  ...
  },
  {
    ...
    body: () => (
      <p className="content">
        ...
        cycling practices. <span className="italic">We actively encourage and support the development of public cycling facilities and
        ...
        <div className="content">
          ...
          <ul>
            ...
            <li>Each member shall abide by applicable traffic laws, rules, and regulations while engaged in a
              ...
              within the organization and in the wider community. <span className="italic">It is the collective responsibility of all
