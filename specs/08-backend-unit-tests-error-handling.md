...
// Layer builders
export const TestStripeLayer = (service: StripeService) => Layer.succeed(StripeTag, service);

export const TestFirestoreLayer = (service: FirestoreService) =>
  Layer.succeed(FirestoreTag, service);

export const TestAuthLayer = (service: AuthService) => Layer.succeed(AuthTag, service);
