...
| ------------ | ------- | ---------------------------------------- |
| `pnpm tsc`   | ✅ PASS | No TypeScript errors                     |
| `pnpm lint`  | ⚠️ PASS | Pre-existing warnings (not from this PR) |
| `pnpm test`  | ✅ PASS | 150 tests passing (+11 new)              |
...
| `src/components/admin/ReconciliationTool.tsx`  | onKeyPress → onKeyDown                                   | +2 / -2   |
